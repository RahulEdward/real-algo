...
Before installing RealAlgo, ensure you have the following prerequisites installed:
...
2. **Clone the Repository**: 
   Open the VS Code Terminal and clone the RealAlgo repository:
   ```bash
...
5. **Configure Environment Variables**: 
   - Rename `.sample.env` to `.env` in the `realalgo` folder
...
For more detailed configuration instructions, visit [https://docs.realalgo.in](https://docs.realalgo.in)
