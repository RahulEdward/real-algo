...
def transform_data(data, token):
    """
    Transforms the RealAlgo API request structure to Firstock's expected structure.
...
def map_order_type(pricetype):
    """
    Maps the RealAlgo pricetype to Firstock's order type.
    """
...
def map_product_type(product):
    """
    Maps the RealAlgo product type to Firstock's product type.
    """
...
def reverse_map_product_type(product):
    """
    Maps Firstock's product type to RealAlgo product type.
    """
