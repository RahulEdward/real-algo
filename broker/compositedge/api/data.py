...
from broker.compositedge.api.auth_api import get_feed_token as refresh_feed_token
...
class BrokerData:
    ...
    def _fetch_market_data(
        ...
        """
        Helper method to fetch market data from CompositEdge API
        Args:
    ...
    def _process_multiquotes_batch(self, symbols: list) -> list:
        ...
        try:
            ...
            if not response or response.get("type") != "success":
                ...
                raise Exception(f"Error from CompositEdge API: {error_msg}")
        ...
        try:
            ...
            while current_start <= to_date:
                ...
                if not response or response.get("type") != "success":
                    ...
                    raise Exception(
                        f"Error from CompositEdge API: {response.get('description', 'Unknown error')}"
                    )
