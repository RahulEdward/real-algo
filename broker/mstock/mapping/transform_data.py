...
def get_mstock_symbol(symbol: str, exchange: str) -> str:
    ...
    Args:
        symbol: RealAlgo format symbol (e.g., "NHPC")
...
def transform_data(data, token):
    """
    Transforms the RealAlgo API request structure to mStock Type B format.

    Args:
        data: RealAlgo order data
...
def transform_modify_order_data(data, token):
    """
    Transforms the RealAlgo modify order request to mStock Type B format.

    Args:
        data: RealAlgo modify order data
        token: Symbol token from database
...
def map_order_type(pricetype):
    """
    Maps RealAlgo pricetype to mStock Type B order type.
...
def map_product_type(product):
    """
    Maps RealAlgo product type to mStock Type B product type.
...
def map_variety(pricetype):
    """
    Maps RealAlgo pricetype to mStock Type B variety.
...
def reverse_map_product_type(product):
    """
    Reverse maps mStock Type B product type to RealAlgo product type.
    """
