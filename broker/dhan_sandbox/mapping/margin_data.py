...
def transform_margin_position(position, client_id):
    """
    Transform a single RealAlgo margin position to Dhan Sandbox margin format.
...
def map_product_type_for_margin(product):
    """
    Maps RealAlgo product type to Dhan Sandbox product type for margin calculation.
...
def parse_margin_response(response_data):
    """
    Parse Dhan Sandbox margin response to RealAlgo standard format.
