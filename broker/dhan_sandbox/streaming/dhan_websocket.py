"""
Complete Dhan WebSocket client wrapper for RealAlgo.
...
class DhanWebSocket:
    ...
    Bridges the async implementation with RealAlgo's threading model.
    """
    ...
    def _parse_ticker_data(self, packet_data):
        ...
        try:
            ...
            # Create tick dictionary in RealAlgo format
            tick = {
                "token": token,
    ...
    def _parse_market_update(self, packet_data):
        ...
        try:
            ...
            tick = {
                ...
                "close": close_price,
                "mode": "QUOTE",
                # Additional fields for RealAlgo compatibility
    ...
    def _check_and_send_depth_20(self, token):
        ...
        try:
            ...
            # Format depth data to match the RealAlgo standard
            formatted_bids = []
            if data.get("bids"):
            ...
            # Create tick data in RealAlgo format with enhanced depth information
            tick = {
                "token": token,
                "instrument_token": token,
                "exchange": exchange,
