...
def transform_data(data):
    """
    Transforms the RealAlgo Platform API request structure to the format expected by the Fyers API.
    """
...
def map_order_type(pricetype):
    """
    Maps the RealAlgo pricetype to the Fyers order type.
    """
...
def map_action(action):
    """
    Maps the RealAlgo action to the Fyers side.
    """
...
def map_product_type(product):
    """
    Maps the RealAlgo product type to the Fyers product type.
    """
...
def reverse_map_product_type(product):
    """
    Reverse maps the Fyers product type to the RealAlgo product type.
    """
    ...
    if oa_product is None:
        logger.warning(
            f"Unknown Fyers product type '{product}' received. Cannot map to RealAlgo product type."
        )
    return oa_product
