...
def transform_margin_positions(positions):
    """
    Transform RealAlgo margin position format to Fyers margin format.
...
def parse_margin_response(response_data):
    """
    Parse Fyers margin response to RealAlgo standard format.
    ...
    try:
        ...
        # Return standardized format matching RealAlgo specification
