...
Converts RealAlgo symbols to Fyers HSM format for WebSocket streaming
...
class FyersTokenConverter:
    ...
    def get_brsymbols_from_database(
        ...
        """
        Lookup brsymbols from database using RealAlgo symbol and exchange
    ...
    def convert_realalgo_symbols_to_hsm(
        self, symbol_info_list: list[dict], data_type: str = "SymbolUpdate"
    ) -> tuple[list[str], dict[str, str], list[str]]:
        """
        Convert RealAlgo symbols to HSM tokens using database lookup for brsymbols
        ...
        try:
            ...
            # self.logger.info(f"Converting RealAlgo symbols: {symbol_exchange_pairs}")
            ...
            self.logger.error(f"RealAlgo symbol conversion error: {e}")
    ...
    def convert_realalgo_to_fyers_symbol(self, exchange: str, symbol: str) -> str:
        """
        Convert RealAlgo format (exchange, symbol) to Fyers symbol format
