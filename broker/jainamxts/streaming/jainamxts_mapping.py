...
class JainamXTSExchangeMapper:
    """Maps between RealAlgo exchange codes and JainamXTS specific exchange types"""

    # Exchange type mapping for JainamXTS broker
    # Format: {RealAlgo_Exchange: JainamXTS_Exchange_Code}
    ...
    # Reverse mapping for converting JainamXTS exchange codes to RealAlgo format
    # Format: {JainamXTS_Exchange_Code: RealAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert RealAlgo exchange code to JainamXTS specific exchange type
    ...
    @staticmethod
    def get_realalgo_exchange(jainamxts_code):
        """
        Convert JainamXTS exchange code to RealAlgo exchange code
