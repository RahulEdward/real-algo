...
class UpstoxExchangeMapper:
    """Maps between RealAlgo exchange codes and Upstox specific exchange types"""

    # Exchange type mapping for Upstox broker
    # Format: {RealAlgo_Exchange: Upstox_Exchange_Code}
    EXCHANGE_TYPES = {
        # NSE Segments
    ...
    # Reverse mapping for converting Upstox exchange codes to RealAlgo format
    # Format: {Upstox_Exchange_Code: RealAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert RealAlgo exchange code to Upstox specific exchange type
    ...
    @staticmethod
    def get_realalgo_exchange(upstox_code):
        """
        Convert Upstox exchange code to RealAlgo exchange code
