...
class GrowwExchangeMapper:
    """Maps RealAlgo exchange codes to Groww exchange/segment format"""

    # Mapping from RealAlgo exchange to Groww exchange and segment
    EXCHANGE_MAP = {
    ...
    @classmethod
    def get_exchange(cls, realalgo_exchange: str) -> str:
        """
        Get Groww exchange from RealAlgo exchange code

        Args:
            realalgo_exchange: RealAlgo exchange code (e.g., 'NSE', 'NFO')

        Returns:
            str: Groww exchange code
        """
        mapping = cls.EXCHANGE_MAP.get(realalgo_exchange, {})
        return mapping.get("exchange", realalgo_exchange)

    @classmethod
    def get_segment(cls, realalgo_exchange: str) -> str:
        """
        Get Groww segment from RealAlgo exchange code
    ...
    @classmethod
    def get_exchange_segment(cls, realalgo_exchange: str) -> tuple:
        """
        Get both exchange and segment from RealAlgo exchange code

        Args:
            realalgo_exchange: RealAlgo exchange code

        Returns:
            tuple: (exchange, segment)
        """
        mapping = cls.EXCHANGE_MAP.get(realalgo_exchange, {})
        return mapping.get("exchange", realalgo_exchange), mapping.get("segment", "CASH")
