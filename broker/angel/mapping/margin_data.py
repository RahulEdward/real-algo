...
def transform_margin_positions(positions):
    """
    Transform RealAlgo margin position format to Angel Broking margin format.
...
def map_product_type(product):
    """
    Maps RealAlgo product type to Angel Broking product type.
...
def map_order_type(pricetype):
    """
    Maps RealAlgo price type to Angel Broking order type.

    RealAlgo: MARKET, LIMIT, SL, SL-M
...
def parse_margin_response(response_data):
    """
    Parse Angel Broking margin calculator response to RealAlgo standard format.
