...
class IndmoneyExchangeMapper:
    """Maps RealAlgo exchange codes to INDmoney-specific segment codes"""
...
class IndmoneyModeMapper:
    ...
    # Mode mapping: RealAlgo mode number -> INDmoney mode string
    MODE_MAP = {
    ...
    def get_indmoney_mode(mode):
        """
        Convert RealAlgo mode number to INDmoney mode string

        Args:
            mode (int): RealAlgo mode (1: LTP, 2: Quote)
    ...
    @staticmethod
    def get_realalgo_mode(indmoney_mode):
        """
        Convert INDmoney mode string to RealAlgo mode number

        Args:
            indmoney_mode (str): INDmoney mode ('ltp' or 'quote')

        Returns:
            int: RealAlgo mode number
        """
