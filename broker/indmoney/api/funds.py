...
# Default response format for margin data (RealAlgo standard format)
...
def get_margin_data(auth_token):
    ...
    try:
        ...
        try:
            ...
            # RealAlgo standard required keys (matching Angel broker format)
            required_keys = [
                "availablecash",
                "collateral",
                "m2mrealized",
            ...
            # Prepare the response in RealAlgo standard format
            processed_data = {}

            # Map INDmoney fields to RealAlgo standard fields
            field_mapping = {
