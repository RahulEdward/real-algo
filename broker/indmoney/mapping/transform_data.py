...
def transform_data(data, token):
    """
    Transforms the RealAlgo API request structure to Indmoney API structure.
    ...
    # Basic mapping from RealAlgo to Indmoney
...
def transform_modify_order_data(data):
    """
    Transforms RealAlgo modify order data to Indmoney format.
    """
    transformed = {
...
def map_order_type(pricetype):
    """
    Maps RealAlgo pricetype to Indmoney order_type.
    """
    order_type_mapping = {
        "MARKET": "MARKET",
...
def map_exchange(br_exchange):
    """
    Maps Indmoney exchange back to RealAlgo exchange.
    """
...
def reverse_map_product_type(product):
    """
    Maps Indmoney product type back to RealAlgo product type.
    """
