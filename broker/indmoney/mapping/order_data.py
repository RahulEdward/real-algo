...
def map_trade_data(trade_data):
    ...
    try:
        ...
        for trade in trade_data:
            ...
            # Map product type from IndMoney format to RealAlgo format
...
def transform_tradebook_data(tradebook_data):
    """
    Transform trade book data to RealAlgo standard format.
...
def transform_positions_data(positions_data):
    """
    Transform positions data to RealAlgo standard format.
    Matches the structure used by Angel broker for consistency.

    RealAlgo Standard Fields:
    ...
    try:
        ...
        for position in positions_data:
            ...
            # RealAlgo standard format (matching Angel broker structure)
            transformed_position = {
                ...
                ),  # Float as per RealAlgo standard
