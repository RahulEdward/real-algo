...
class FivePaisaExchangeMapper:
    """Maps RealAlgo exchange codes to 5Paisa-specific exchange codes"""
    ...
    def get_exchange_code(exchange: str) -> str:
        """
        Convert RealAlgo exchange code to 5Paisa exchange code

        Args:
            exchange (str): RealAlgo exchange code (e.g., 'NSE', 'BSE', 'NFO')
    ...
    def get_exchange_type(exchange: str) -> str:
        """
        Convert RealAlgo exchange to 5Paisa exchange type
