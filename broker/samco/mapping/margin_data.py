...
def transform_margin_position(position):
    """
    Transform a single RealAlgo margin position to Samco span margin format.
...
def parse_margin_response(response_data):
    """
    Parse Samco span margin response to RealAlgo standard format.
