...
def transform_data(data, token):
    """
    Transforms the RealAlgo API request structure to Samco expected structure.
    """
...
def transform_modify_order_data(data):
    """
    Transforms the RealAlgo modify order request to Samco expected structure.
...
def map_order_type(pricetype):
    """
    Maps RealAlgo pricetype to Samco order type.
    """
...
def map_product_type(product):
    """
    Maps RealAlgo product type to Samco product type.
    """
...
def reverse_map_product_type(product):
    """
    Maps Samco product type back to RealAlgo product type.
    """
