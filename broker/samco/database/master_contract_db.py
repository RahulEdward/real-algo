...
def get_index_data():
    ...
    nse_indices = [
        ...
        {
            "symbol": "FINNIFTY",
            "brsymbol": "NIFTY FIN SERVICE",
            "name": "Nifty Fin Service",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_FIN_SERVICE",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "MIDCPNIFTY",
            "brsymbol": "NIFTY MID SELECT",
            "name": "Nifty Mid Select",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_MID_SELECT",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTYNXT50",
            "brsymbol": "NIFTY NEXT 50",
            "name": "Nifty Next 50",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_NEXT_50",
        ...
        },
        {
            ...
            "brsymbol": "NIFTY MIDCAP 50",
            "name": "Nifty Midcap 50",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_MIDCAP_50",
            "instrumenttype": "INDEX",
        },
        # Sectoral Indices
        {
        ...
        {
            "symbol": "NIFTYPSUBANK",
            "brsymbol": "NIFTY PSU BANK",
            "name": "Nifty PSU Bank",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_PSU_BANK",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTYPVTBANK",
            "brsymbol": "NIFTY PVT BANK",
            "name": "Nifty Pvt Bank",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_PVT_BANK",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTYINFRA",
            "brsymbol": "NIFTY INFRA",
            "name": "Nifty Infra",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_INFRA",
        ...
        },
        {
            ...
            "brsymbol": "NIFTY COMMODITIES",
            "name": "Nifty Commodities",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_COMMODITIES",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTYCONSUMPTION",
            "brsymbol": "NIFTY CONSUMPTION",
            "name": "Nifty Consumption",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_CONSUMPTION",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTYMNC",
        ...
        {
            "symbol": "NIFTYSERVSECTOR",
            "brsymbol": "NIFTY SERV SECTOR",
            "name": "Nifty Services Sector",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_SERV_SECTOR",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTYGROWSECT15",
            "brsymbol": "NIFTY GROWSECT 15",
            "name": "Nifty Growth Sectors 15",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_GROWSECT_15",
            "instrumenttype": "INDEX",
        },
        # Thematic Indices
        {
            "symbol": "NIFTYDIVOPPS50",
            "brsymbol": "NIFTY DIV OPPS 50",
            "name": "Nifty Dividend Opportunities 50",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_DIV_OPPS_50",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTY50VALUE20",
            "brsymbol": "NIFTY50 VALUE 20",
            "name": "Nifty50 Value 20",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY50_VALUE_20",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTYQUALITY30",
            "brsymbol": "NIFTY Quality 30",
            "name": "Nifty Quality 30",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_QUALITY_30",
            "instrumenttype": "INDEX",
        },
        # Liquidity Indices
        {
            "symbol": "NIFTYMIDLIQ15",
            "brsymbol": "NIFTY Mid LIQ 15",
            "name": "Nifty Midcap Liquid 15",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_MID_LIQ_15",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTY100LIQ15",
            "brsymbol": "NIFTY100 LIQ 15",
            "name": "Nifty100 Liquid 15",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY100_LIQ_15",
            "instrumenttype": "INDEX",
        },
        # Free Float Indices
        {
            "symbol": "NIFTYMID100FREE",
            "brsymbol": "NIFTY MID100 FREE",
            "name": "Nifty Midcap 100 Free Float",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_MID100_FREE",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTYSML100FREE",
            "brsymbol": "NIFTY SML100 FREE",
            "name": "Nifty Smallcap 100 Free Float",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY_SML100_FREE",
            "instrumenttype": "INDEX",
        },
        # Strategy Indices (Leveraged/Inverse)
        {
            "symbol": "NIFTY50PR1XINV",
            "brsymbol": "NIFTY50 PR 1x INV",
            "name": "Nifty50 PR 1x Inverse",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY50_PR_1X_INV",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTY50PR2XLEV",
            "brsymbol": "NIFTY50 PR 2x LEV",
            "name": "Nifty50 PR 2x Leverage",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY50_PR_2X_LEV",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTY50TR1XINV",
            "brsymbol": "NIFTY50 TR 1x INV",
            "name": "Nifty50 TR 1x Inverse",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY50_TR_1X_INV",
            "instrumenttype": "INDEX",
        },
        {
            "symbol": "NIFTY50TR2XLEV",
            "brsymbol": "NIFTY50 TR 2x LEV",
            "name": "Nifty50 TR 2x Leverage",
            "exchange": "NSE_INDEX",
            "brexchange": "NSE",
            "token": "NIFTY50_TR_2X_LEV",
            "instrumenttype": "INDEX",
        },
        # Volatility Index
        {
    ...
    bse_indices = [
        ...
        },
        {
            "symbol": "BSECD",
            "brsymbol": "BSE CD",
            "name": "S&P BSE Consumer Durables",
            "exchange": "BSE_INDEX",
            "brexchange": "BSE",
            "token": "BSE_CD",
            "instrumenttype": "INDEX",
        ...
        },
        {
            "symbol": "BSEFMC",
            "brsymbol": "BSEFMC",
            "name": "S&P BSE Fast Moving Consumer Goods",
            "exchange": "BSE_INDEX",
            "brexchange": "BSE",
            "token": "BSE_FMC",
            "instrumenttype": "INDEX",
        ...
        },
        {
            "symbol": "BSECDGS",
            "brsymbol": "CDGS",
            "name": "S&P BSE Consumer Discretionary Goods & Services",
            "exchange": "BSE_INDEX",
            "brexchange": "BSE",
            "token": "BSE_CDGS",
            "instrumenttype": "INDEX",
...
def process_samco_data(df):
    """
    Process Samco ScripMaster CSV data to fit the RealAlgo database schema.
    """
    ...
    # Convert expiry date to RealAlgo format (DD-MMM-YY)
    ...
    # Map index instruments to RealAlgo exchange format
    ...
    nfo_fut_mask = (df["exchange"] == "NFO") & (
        df["instrumenttype"].isin(["FUTIDX", "FUTSTK", "FUT"])
    )
    if nfo_fut_mask.any():
        df.loc[nfo_fut_mask, "symbol"] = df["name"].fillna("") + expiry_for_symbol + "FUT"

    # NFO Options: NAME + EXPIRY + STRIKE + CE/PE (e.g., NIFTY26FEB241480CE)
    nfo_opt_mask = (df["exchange"] == "NFO") & (
        df["instrumenttype"].isin(["OPTIDX", "OPTSTK", "CE", "PE"])
    )
    if nfo_opt_mask.any():
        df.loc[nfo_opt_mask & df["brsymbol"].str.endswith("CE", na=False), "symbol"] = (
            df["name"].fillna("") + expiry_for_symbol + format_strike(df["strike"]) + "CE"
        )
        df.loc[nfo_opt_mask & df["brsymbol"].str.endswith("PE", na=False), "symbol"] = (
            df["name"].fillna("") + expiry_for_symbol + format_strike(df["strike"]) + "PE"
        )

    # MCX Futures: NAME + EXPIRY + FUT (e.g., CRUDEOILM20MAY24FUT)
    mcx_fut_mask = (df["exchange"] == "MCX") & (df["instrumenttype"].isin(["FUTCOM", "FUT"]))
    if mcx_fut_mask.any():
        df.loc[mcx_fut_mask, "symbol"] = df["name"].fillna("") + expiry_for_symbol + "FUT"
    ...
    cds_fut_mask = (df["exchange"] == "CDS") & (
        df["instrumenttype"].isin(["FUTCUR", "FUTIRC", "FUT"])
    )
    if cds_fut_mask.any():
        df.loc[cds_fut_mask, "symbol"] = df["name"].fillna("") + expiry_for_symbol + "FUT"

    # CDS Options: NAME + EXPIRY + STRIKE + CE/PE (e.g., USDINR19APR2482CE)
    cds_opt_mask = (df["exchange"] == "CDS") & (
        df["instrumenttype"].isin(["OPTCUR", "OPTIRC", "CE", "PE"])
    )
    if cds_opt_mask.any():
    ...
    if bfo_fut_mask.any():
        df.loc[bfo_fut_mask, "symbol"] = df["name"].fillna("") + expiry_for_symbol + "FUT"
