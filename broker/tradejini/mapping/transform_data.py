...
def transform_data(data, token):
    """
    Transforms RealAlgo order format to Tradejini API format.
    """
...
def transform_modify_order_data(data, token):
    """
    Transforms RealAlgo modify order format to Tradejini API format.

    Args:
        data (dict): RealAlgo modify order data
...
def map_order_type(pricetype):
    """
    Maps RealAlgo order types to Tradejini order types.
    """
    order_type_mapping = {
        "MARKET": "market",
        "LIMIT": "limit",
...
def map_product_type(product):
    """
    Maps RealAlgo product types to Tradejini product types.
    """
...
def map_validity(validity):
    """
    Maps RealAlgo validity types to Tradejini validity types.
    """
...
def reverse_map_product_type(product):
    """
    Maps Tradejini product types back to RealAlgo product types.
    """
