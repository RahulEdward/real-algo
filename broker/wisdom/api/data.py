...
class BrokerData:
    def __init__(self, auth_token, feed_token=None, user_id=None):
        """Initialize Wisdom data handler with authentication token"""
        self.auth_token = auth_token
        self.feed_token = feed_token
        self.user_id = user_id

        # Map common timeframe format to Wisdom intervals
        self.timeframe_map = {
            "1s": "1",
            "1m": "60",
            "2m": "120",
    ...
    def _fetch_market_data(
        ...
        """
        Helper method to fetch market data from Wisdom API
        Args:
    ...
    def get_history(self, symbol, exchange, timeframe, from_date, to_date):
        ...
        try:
            ...
            while current_start <= to_date:
                ...
                # Wisdom expects MMM DD YYYY HHMMSS in IST
                ...
                if not response or response.get("type") != "success":
                    ...
                    raise Exception(
                        f"Error from Wisdom API: {response.get('description', 'Unknown error')}"
                    )
    ...
    def get_market_depth(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            logger.debug("Returning empty market depth structure")
            return empty_depth
