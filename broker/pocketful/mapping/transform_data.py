...
def transform_data(data, client_id=None, auth_token=None):
    """
    Transforms RealAlgo order format to Pocketful order format.
    ...
    Args:
        data: RealAlgo order data dictionary
...
def transform_modify_order_data(data, client_id=None):
    """
    Transforms RealAlgo order modification format to Pocketful order format.
...
def map_order_type(pricetype):
    """
    Maps RealAlgo pricetype to Pocketful order type.
    """
    order_type_mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
...
def map_product_type(product):
    """
    Maps RealAlgo product type to Pocketful product type.
    """
...
def reverse_map_product_type(exchange, product):
    """
    Reverse maps the broker product type to the RealAlgo product type, considering the exchange.
    """
    # Exchange to RealAlgo product type mapping for 'D'
    exchange_mapping = {
        "CNC": "CNC",
        "NRML": "NRML",
        "MIS": "MIS",
