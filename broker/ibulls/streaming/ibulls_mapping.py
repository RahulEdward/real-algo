...
class IbullsExchangeMapper:
    """Maps between RealAlgo exchange codes and Ibulls XTS specific exchange types"""

    # Exchange type mapping for Ibulls XTS broker
    # Format: {RealAlgo_Exchange: iBulls_Exchange_Code}
    ...
    # Reverse mapping for converting iBulls exchange codes to RealAlgo format
    # Format: {iBulls_Exchange_Code: RealAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert RealAlgo exchange code to Ibulls XTS specific exchange type
    ...
    @staticmethod
    def get_realalgo_exchange(ibulls_code):
        """
        Convert Ibulls XTS exchange code to RealAlgo exchange code
