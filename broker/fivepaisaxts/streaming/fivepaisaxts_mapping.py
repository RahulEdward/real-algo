...
class FivepaisaXTSExchangeMapper:
    """Maps between RealAlgo exchange codes and Fivepaisa XTS specific exchange types"""

    # Exchange type mapping for Fivepaisa XTS broker
    # Format: {RealAlgo_Exchange: Fivepaisa_Exchange_Code}
    ...
    # Reverse mapping for converting Fivepaisa exchange codes to RealAlgo format
    # Format: {Fivepaisa_Exchange_Code: RealAlgo_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert RealAlgo exchange code to Fivepaisa XTS specific exchange type
    ...
    @staticmethod
    def get_realalgo_exchange(fivepaisaxts_code):
        """
        Convert Fivepaisa XTS exchange code to RealAlgo exchange code
