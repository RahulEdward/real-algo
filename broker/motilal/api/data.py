...
class BrokerData:
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        Args:
            symbol: Trading symbol (RealAlgo format)
        ...
        try:
            ...
            # Map RealAlgo exchange to Motilal exchange
            ...
            # Return quote in RealAlgo common format
            return {
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        This follows the RealAlgo standard structure matching Angel and other brokers.
        ...
        Returns:
            dict: Market depth data in RealAlgo standard format
        """
        ...
        try:
            ...
            # Return in Angel's RealAlgo standard format (matching lines 524-537 of angel/api/data.py)
            return {
                "bids": formatted_bids,
                "asks": formatted_asks,
                "high": high,
