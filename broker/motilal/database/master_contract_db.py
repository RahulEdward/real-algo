...
def process_motilal_index_csv(df, exchange_name):
    """
    Processes the Motilal Index CSV file to fit the RealAlgo database schema.
    ...
    # Map exchange to RealAlgo format with _INDEX suffix
    ...
    # Standardize index names to match RealAlgo format
...
def process_motilal_csv(df, exchange_name):
    """
    Processes the Motilal CSV file to fit the RealAlgo database schema.
    ...
    # Rename columns based on Motilal API format to RealAlgo schema
    df = df.rename(
        columns={
            "scripcode": "token",
            "scripname": "symbol",
    ...
    # Map Motilal exchange names to RealAlgo exchange names
    exchange_map = {
        "NSE": "NSE",
        "BSE": "BSE",
        "NSEFO": "NFO",
    ...
    # Format symbols according to RealAlgo standards
