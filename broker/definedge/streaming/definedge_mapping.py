...
class DefinedgeExchangeMapper:
    """Maps RealAlgo exchange codes to DefinEdge-specific exchange types"""
    ...
    def get_exchange_code(exchange):
        """
        Convert RealAlgo exchange code to DefinEdge exchange code

        Args:
            exchange (str): RealAlgo exchange code
