...
class BrokerData:
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        try:
            ...
            # Map Definedge response fields to RealAlgo format
    ...
    def get_history(
        ...
        try:
            ...
            if interval == "D":
                ...
                # This ensures the RealAlgo client interprets them correctly
            ...
            # Reorder columns to match RealAlgo format (timestamp should be 5th column)
