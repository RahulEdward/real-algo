...
def transform_margin_positions(positions):
    """
    Transform RealAlgo margin positions to Definedge Span Calculator format.
...
def parse_margin_response(response_data):
    """
    Parse Definedge margin response to RealAlgo standard format.
    ...
    try:
        ...
        # Return standardized RealAlgo format
        return {
            "status": "success",
            "data": {
