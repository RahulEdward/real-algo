...
GoCharting is a professional HTML5 charting platform optimized for Indian markets. With a **Premium Plan**, you can set up webhook alerts to automate your trading strategies with RealAlgo.
...
### 2. RealAlgo Setup
- RealAlgo instance running and accessible
- API key configured in RealAlgo
...
If you're running RealAlgo locally (on your computer) and want to test webhooks, you'll need to expose your local server to the internet using a tunneling service.
...
1. **Login to RealAlgo**
   - Navigate to your RealAlgo dashboard
...
5. **Configure Delivery Methods**
   ...
   - ☑️ **Webhook**: Enable this for RealAlgo integration

   **Webhook URL**: Paste your RealAlgo webhook URL
   ```
   https://yourdomain.com/api/v1/placeorder
   ```
...
1. **Enable Sandbox Mode in RealAlgo**
...
1. Enable **Analyze Mode** in RealAlgo (toggle in navbar)
2. Create a test alert in GoCharting with a condition that will trigger immediately
3. Check the **API Analyzer** in RealAlgo to see the incoming request
...
```json
{
  "apikey": "your_api_key_here",      // Your RealAlgo API key
...
|-------|----------|-------------|--------------|
| apikey | Yes | Your RealAlgo API key | String |
...
4. **Test tunnel accessibility**
   ...
   - You should see RealAlgo login page
...
### 3. Monitor Activity
- Regularly check order logs in RealAlgo
...
RealAlgo has rate limiting to prevent abuse:
...
### Documentation
- RealAlgo Docs: https://docs.realalgo.in
- GoCharting Help: https://gocharting.com/help

### Community
- RealAlgo GitHub: https://github.com/marketcalls/realalgo
...
A: Check the Logs section in RealAlgo or use the API Analyzer in Analyze Mode.
...
**Happy Trading with GoCharting and RealAlgo! 🚀**
