# RealAlgo Frontend Documentation

Welcome to the RealAlgo React frontend documentation. This guide covers everything you need to know to develop, test, and maintain the frontend application.
...
RealAlgo frontend is a single-page application (SPA) that provides:
