#!/usr/bin/env python3
"""
RealAlgo – New Broker Integration Test
...
# ───────────────── CONFIG ─────────────────
API_KEY = os.getenv(
    "REALALGO_API_KEY", "3bb8d260915ff680a7258108c0483b9eb7675ced31309a36f5846366943ee9fa"
)
...
if __name__ == "__main__":
    try:
        from realalgo import api as OAClient
    except ImportError:
        print(red("realalgo SDK missing – pip install realalgo"))
        sys.exit(1)
