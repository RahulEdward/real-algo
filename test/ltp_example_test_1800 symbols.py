"""
RealAlgo WebSocket LTP Example - 1800 Symbols Test
...
# Add parent directory to path to import realalgo
...
try:
    ...
    print("Error: Could not import realalgo. Make sure you're running from the correct directory.")
    sys.exit(1)
...
def main():
    print("RealAlgo WebSocket LTP Example - 1800 Symbols Test")
    print("=" * 60)
