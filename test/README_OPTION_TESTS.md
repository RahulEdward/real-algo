...
1. Enable **Analyze Mode** in RealAlgo settings
2. Run the tests
...
1. Disable **Analyze Mode** in RealAlgo settings
2. Run the tests
...
**Solution**: Make sure RealAlgo is running at `http://127.0.0.1:5000`
...
**Solution**: Replace API key in test file with your actual API key from RealAlgo settings
...
- Check RealAlgo logs for detailed error messages
