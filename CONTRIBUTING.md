# Contributing to RealAlgo


## Let's democratize algorithmic trading, together!

We're thrilled that you're interested in contributing to RealAlgo! This guide will help you get started, whether you're fixing a bug, adding a new broker, improving documentation, or building new features.

Below you'll find everything you need to set up RealAlgo on your computer and start contributing.

---

## Our Mission

RealAlgo is built **by traders, for traders**. We believe in democratizing algorithmic trading by providing a broker-agnostic, open-source platform that puts control back in the hands of traders. Every contribution, no matter how small, helps us achieve this mission.
...
RealAlgo is built using **Python Flask** for the backend and **TailwindCSS + DaisyUI** for the frontend.
...
RealAlgo requires CSS compilation before running. You have two options:
...
# Clone your fork
git clone https://github.com/YOUR_USERNAME/realalgo.git
cd realalgo

# Add upstream remote
git remote add upstream https://github.com/marketcalls/realalgo.git
...
2. **Bug Fixes**
   - Check [issues labeled "good first issue"](https://github.com/marketcalls/realalgo/labels/good%20first%20issue)
...
RealAlgo primarily uses manual testing currently:
...
├── mapping/
│   ├── order_data.py         # Transform RealAlgo format to broker format
...
3. Configure in RealAlgo settings
...
RealAlgo uses [DaisyUI](https://daisyui.com/components/) component library:
...
1. **Python Docstrings** - Use Google-style:
   ...
   def place_order(symbol, quantity, price, order_type):
       ...
       Args:
           symbol (str): Trading symbol in RealAlgo format
...
- **GitHub Discussions**: Ask questions in [GitHub Discussions](https://github.com/marketcalls/realalgo/discussions)
- **Documentation**: Check [docs.realalgo.in](https://docs.realalgo.in)
- **GitHub Issues**: Report bugs in [Issues](https://github.com/marketcalls/realalgo/issues)

### Before Asking for Help

1. **Search existing issues** - Your question might already be answered
2. **Check documentation** - Review docs at docs.realalgo.in
...
**Steps to reproduce**:
1. Start RealAlgo with `python app.py`
...
- **Part of the RealAlgo community** on Discord
...
- **Repository**: [github.com/marketcalls/realalgo](https://github.com/marketcalls/realalgo)
- **Issue Tracker**: [github.com/marketcalls/realalgo/issues](https://github.com/marketcalls/realalgo/issues)
...
- **PyPI Package**: [pypi.org/project/realalgo](https://pypi.org/project/realalgo)
- **YouTube**: [youtube.com/@realalgoHQ](https://youtube.com/@realalgoHQ)
...
RealAlgo is released under the **AGPL v3.0 License**. See the [LICENSE](License.md) file for details.

By contributing to RealAlgo, you agree that your contributions will be licensed under the AGPL v3.0 License.

---

## Thank You! 

Thank you for contributing to RealAlgo! Your efforts help democratize algorithmic trading and empower traders worldwide. Every line of code, documentation improvement, and bug report makes a difference.

**Happy coding, and welcome to the RealAlgo community!** 
