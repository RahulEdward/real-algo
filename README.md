...
[![PyPI Downloads](https://static.pepy.tech/badge/realalgo)](https://pepy.tech/projects/realalgo)
[![PyPI Downloads](https://static.pepy.tech/badge/realalgo/month)](https://pepy.tech/projects/realalgo)
[![X (formerly Twitter) Follow](https://img.shields.io/twitter/follow/realalgoHQ)](https://twitter.com/realalgoHQ)
[![YouTube Channel Subscribers](https://img.shields.io/youtube/channel/subscribers/UCw7eVneIEyiTApy4RtxrJsQ)](https://www.youtube.com/@realalgo)
[![Discord](https://img.shields.io/discord/1219847221055455263)](https://discord.com/invite/UPh7QPsNhP)

</div>

**RealAlgo** is a production-ready, open-source algorithmic trading platform built with FastAPI and React. It provides a unified API layer across 24+ Indian brokers, enabling seamless integration with popular platforms like TradingView, Amibroker, Excel, Python, and AI agents. Designed for traders and developers, RealAlgo makes algo trading accessible, secure, and powerful.

## Quick Links

- **Documentation**: [docs.realalgo.in](https://docs.realalgo.in)
- **Installation Guide**: [Getting Started](https://docs.realalgo.in/installation-guidelines/getting-started)
- **Upgrade Guide**: [Upgrade Instructions](https://docs.realalgo.in/installation-guidelines/getting-started/upgrade)
- **Why RealAlgo**: [Why Build with RealAlgo](https://docs.realalgo.in/why-to-build-with-realalgo)
- **Video Tutorial**:

[![What is RealAlgo](https://img.youtube.com/vi/kAS3jTb3OkI/0.jpg)](https://www.youtube.com/watch?v=kAS3jTb3OkI)
...
[API Analyzer Documentation](https://docs.realalgo.in/new-features/api-analyzer)
...
[Action Center Documentation](https://docs.realalgo.in/new-features/action-center)

### Python Strategy Manager
Host and run Python strategies directly on RealAlgo:
...
- Local and secure integration with your RealAlgo instance
...
[PnL Tracker Documentation](https://docs.realalgo.in/new-features/pnl-tracker)

[Traffic & Latency Monitor Documentation](https://docs.realalgo.in/new-features/traffic-latency-monitor)
...
RealAlgo provides officially supported client libraries for application development and system-level integrations:

| Language / Platform | Repository |
|---------------------|------------|
| Python | [realalgo-python-library](https://github.com/marketcalls/realalgo-python-library) |
| Node.js | [realalgo-node](https://github.com/marketcalls/realalgo-node) |
| Java | [realalgo-java](https://github.com/marketcalls/realalgo-java) |
| Rust | [realalgo-rust](https://github.com/marketcalls/realalgo-rust) |
| .NET / C# | [realalgo.NET](https://github.com/marketcalls/realalgo.NET) |
| Go | [realalgo-go](https://github.com/marketcalls/realalgo-go) |

## RealAlgo FOSS Ecosystem

RealAlgo is part of a larger open-source trading ecosystem:

- **RealAlgo Core**: This repository (Python FastAPI + React)
...
- **Documentation**: Comprehensive guides on [Gitbook](https://docs.realalgo.in/mini-foss-universe)
...
RealAlgo uses the modern `uv` package manager for faster, more reliable installations:
...
# Run the application using UV with FastAPI
uv run uvicorn app_fastapi:app --host 127.0.0.1 --port 5000 --reload
```

The application will be available at `http://127.0.0.1:5000`

For detailed installation instructions, deployment options (Docker, AWS, etc.), and configuration guides, visit [docs.realalgo.in/installation-guidelines/getting-started](https://docs.realalgo.in/installation-guidelines/getting-started)

## API Documentation

Complete API reference and examples:
- **API Documentation**: [docs.realalgo.in/api-documentation/v1](https://docs.realalgo.in/api-documentation/v1)
- **Symbol Format**: [docs.realalgo.in/symbol-format](https://docs.realalgo.in/symbol-format)
...
Comprehensive documentation is available at [docs.realalgo.in](https://docs.realalgo.in):
...
- **Discord**: [Join our community](https://www.realalgo.in/discord)
- **Twitter/X**: [@realalgoHQ](https://twitter.com/realalgoHQ)
- **YouTube**: [@realalgo](https://www.youtube.com/@realalgo)
- **GitHub Issues**: [Report bugs or request features](https://github.com/marketcalls/realalgo/issues)

## License

RealAlgo is released under the **AGPL V3.0 License**. See [LICENSE](LICENSE) for details.

## Credits & Acknowledgments

RealAlgo is built upon the shoulders of giants. We extend our gratitude to all the open-source projects that make this platform possible.

### Core Framework
- **[FastAPI](https://fastapi.tiangolo.com)** - MIT License - Modern, fast Python web framework
- **[Uvicorn](https://www.uvicorn.org)** - BSD License - Lightning-fast ASGI server
- **[Starlette](https://www.starlette.io)** - BSD License - ASGI framework foundation
- **[Pydantic](https://docs.pydantic.dev)** - MIT License - Data validation using Python type annotations
