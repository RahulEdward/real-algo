# services/flow_realalgo_client.py
"""
RealAlgo Client Wrapper for Flow
Provides SDK-like interface using internal RealAlgo services
"""
...
class FlowRealAlgoClient:
    """
    Client wrapper that provides SDK-like interface to RealAlgo services.
    ...
    def __init__(self, api_key: str):
        ...
        Args:
            api_key: The RealAlgo API key for authentication
        """
...
def get_flow_client(api_key: str) -> FlowRealAlgoClient:
    """
    Factory function to create a Flow RealAlgo client.

    Args:
        api_key: The RealAlgo API key

    Returns:
        FlowRealAlgoClient instance
    """
    return FlowRealAlgoClient(api_key)
