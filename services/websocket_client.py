"""
Internal WebSocket client wrapper for connecting to the RealAlgo WebSocket server.
...
class WebSocketClient:
    """
    Internal WebSocket client for connecting to RealAlgo WebSocket server.
