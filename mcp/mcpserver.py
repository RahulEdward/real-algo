...
# Initialize RealAlgo client with provided arguments
...
@mcp.tool()
def get_realalgo_version() -> str:
    """Get the RealAlgo library version."""
    try:
        import realalgo

        return f"RealAlgo version: {realalgo.__version__}"
    except Exception as e:
...
def send_telegram_alert(username: str, message: str) -> str:
    ...
    Args:
        username: RealAlgo login ID/username
