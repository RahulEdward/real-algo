...
# Coded by Rajandran R - Creator of RealAlgo (https://realalgo.in)
# Author - www.marketcalls.in
# ---------------------------------------------------
# NOTE: This code requires RealAlgo to be running locally or on a server.
# Get your API key from your self-hosted RealAlgo platform.
...
print("🔁 RealAlgo Python Bot is running.")
