...
Description: Backtests 10/20 EMA crossover strategy on RELIANCE 5m data
             Data fetched from RealAlgo API, backtested with VectorBT
"""
...
def fetch_historical_data():
    ...
    # RealAlgo history() returns DataFrame directly
...
if __name__ == "__main__":
    try:
        # Step 1: Fetch data from RealAlgo
