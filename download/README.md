...
This tool allows you to download Intraday End of Day (IEOD) data for specified stock symbols from the RealAlgo API.

## Prerequisites

- Python 3.x
- Valid RealAlgo API key
- Access to RealAlgo API endpoint (ensure realalgo is running)
...
1. Ensure you have a valid API key from RealAlgo
