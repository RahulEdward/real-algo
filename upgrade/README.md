...
- Adds user linking between Telegram and RealAlgo
...
1. **Module not found errors**: Ensure you're running from the RealAlgo directory with virtual environment:
   ```bash
   cd /path/to/realalgo
...
*For full documentation, see [RealAlgo Documentation](../docs/)*