# RealAlgo Flow Migration Tracker
...
|---|---------|------|--------|-------------|
| 1 | FlowRealAlgoClient | `services/flow_realalgo_client.py` | ✅ | Direct service wrapper |
...
**Implementation:** `services/flow_realalgo_client.py`
...
> Note: `get_intervals()` not implemented in realalgo-flow backend executor
...
| 2026-01-16 | 2 | Implemented initial service mappings in flow_realalgo_client.py |
...
| 1 | `services/flow_realalgo_client.py` | Direct service wrapper |
...
- **Use:** RealAlgo's existing auth, API key from /playground, DATABASE_URL from .env
- Source nodes path: `realalgo-flow/frontend/src/components/nodes/`
- Target nodes path: `realalgo/frontend/src/components/flow/nodes/`
