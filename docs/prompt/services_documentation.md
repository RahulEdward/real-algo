# RealAlgo Services Documentation

## Overview

RealAlgo Services are Python functions that provide programmatic access to trading operations. These services mirror the functionality of the RealAlgo SDK but are designed for internal use within the RealAlgo application. Each service function accepts the same request parameters and returns the same responses as documented in the RealAlgo SDK.
...
**Location:** `realalgo/services/place_order_service.py`
...
| api_key | str | Conditional | RealAlgo API key (for API-based calls) |
...
**Location:** `realalgo/services/place_smart_order_service.py`
...
| api_key | str | Conditional | RealAlgo API key |
...
**Location:** `realalgo/services/place_options_order_service.py`
...
**Location:** `realalgo/services/options_multiorder_service.py`
...
**Location:** `realalgo/services/basket_order_service.py`
...
**Location:** `realalgo/services/split_order_service.py`
...
**Location:** `realalgo/services/modify_order_service.py`
...
**Location:** `realalgo/services/cancel_order_service.py`
...
**Location:** `realalgo/services/cancel_all_order_service.py`
...
**Location:** `realalgo/services/close_position_service.py`
...
**Location:** `realalgo/services/orderstatus_service.py`
...
**Location:** `realalgo/services/openposition_service.py`
...
**Location:** `realalgo/services/quotes_service.py`
...
**Location:** `realalgo/services/depth_service.py`
...
**Location:** `realalgo/services/history_service.py`
...
**Location:** `realalgo/services/intervals_service.py`
...
**Location:** `realalgo/services/symbol_service.py`
...
**Location:** `realalgo/services/search_service.py`
...
**Location:** `realalgo/services/expiry_service.py`
...
**Location:** `realalgo/services/instruments_service.py`
...
| api_key | str | Yes | RealAlgo API key |
...
**Location:** `realalgo/services/option_symbol_service.py`
...
**Location:** `realalgo/services/option_chain_service.py`
...
**Location:** `realalgo/services/synthetic_future_service.py`
...
**Location:** `realalgo/services/option_greeks_service.py`
...
**Location:** `realalgo/services/funds_service.py`
...
**Location:** `realalgo/services/margin_service.py`
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| apikey | str | Yes | RealAlgo API key |
...
**Location:** `realalgo/services/orderbook_service.py`
...
**Location:** `realalgo/services/tradebook_service.py`
...
**Location:** `realalgo/services/positionbook_service.py`
...
**Location:** `realalgo/services/holdings_service.py`
...
**Location:** `realalgo/services/market_calendar_service.py`
...
**Location:** `realalgo/services/analyzer_service.py`
...
The Telegram Alert Service provides automated notifications for order-related events via Telegram. This service is not part of the SDK yet but is available for internal use within RealAlgo.

**Location:** `realalgo/services/telegram_alert_service.py`
...
- GitHub: https://github.com/marketcalls/realalgo
