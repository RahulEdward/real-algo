# 02 - Why Build with RealAlgo?

*"Why should I use RealAlgo when I can just build my strategy directly on top of the broker's SDK or API?"*
...
**RealAlgo takes care of the heavy lifting.**
...
## What Makes RealAlgo Different?

### Strategy Management & Hosting

Host your **Python strategies directly inside RealAlgo**, alongside strategies from TradingView, Amibroker, ChartInk, MetaTrader, Excel, or custom webhooks. Start, pause, schedule, monitor, and analyze—all from a central control plane.
...
RealAlgo supports **24+ Indian brokers** via a **unified API and WebSocket layer**. Write your strategy once, and run it across Zerodha, Angel One, Dhan, Upstox, Fyers, Flattrade, Firstock, and more—without rewriting code.
...
With RealAlgo's **Common Symbol Format**, you don't have to worry about broker-specific quirks. Contracts, expiries, and lot sizes are maintained automatically.

| Broker | Their Format | RealAlgo Format |
|--------|--------------|-----------------|
| Zerodha | `SBIN` | `SBIN` |
| Angel | `SBIN-EQ` | `SBIN` |
| Dhan | `SBIN` | `SBIN` |
...
RealAlgo is production-tested with enterprise-grade security:
...
| Component | What You'd Build | RealAlgo Provides |
|-----------|------------------|-------------------|
...
RealAlgo ships with all this—**pre-wired, tested, and open source**.

---

## Open Source Freedom

Licensed under **AGPL**, RealAlgo gives you:
...
**RealAlgo gives you *infrastructure*.**
...
And when you're ready to switch brokers or expand to multi-broker setups, you'll already be on **RealAlgo's unified, broker-agnostic foundation**.

---

**Previous**: [01 - What is RealAlgo](../01-what-is-realalgo/README.md)
