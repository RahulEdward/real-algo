...
This guide helps you diagnose and resolve common issues in RealAlgo. Problems are organized by category with step-by-step solutions.
...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                              │
│  □ Is RealAlgo running? (Check terminal/service status)                    │
...
**Symptom**: TradingView/ChartInk alerts not reaching RealAlgo

**Checklist**:
1. Is RealAlgo accessible from internet?
   ```bash
   # Test with curl from external machine
   curl https://your-realalgo-url/health
   ```
...
**Solution**:
1. Copy API key from RealAlgo dashboard
...
**Symptom**: RealAlgo consuming too much RAM
...
```bash
# Application logs
tail -f logs/realalgo.log

# Check for errors
grep -i error logs/realalgo.log
...
RealAlgo is community-driven:

| Channel | Use For | Link |
|---------|---------|------|
| GitHub Issues | Bug reports, feature requests | [github.com/marketcalls/realalgo/issues](https://github.com/marketcalls/realalgo/issues) |
| Discord | Community support, questions | [realalgo.in/discord](http://realalgo.in/discord) |
| Documentation | How-to guides | [docs.realalgo.in](https://docs.realalgo.in) |

### Useful Commands

```bash
# Check RealAlgo version
uv run python -c "import realalgo; print(realalgo.__version__)"
