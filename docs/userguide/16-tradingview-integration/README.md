...
TradingView is a popular charting platform with powerful Pine Script strategy capabilities. RealAlgo connects TradingView alerts to your broker for automated order execution.

## How It Works

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    TradingView → RealAlgo Flow                              │
│                                                                              │
│  ┌─────────────┐     ┌─────────────┐     ┌─────────────┐     ┌──────────┐  │
│  │ TradingView │     │   Webhook   │     │  RealAlgo   │     │  Broker  │  │
...
TradingView webhooks need to reach your RealAlgo server from the internet.
...
```pine
//@version=5
strategy("My RealAlgo Strategy", overlay=true)
...
```
https://your-realalgo-url/api/v1/placesmartorder
```
...
1. Go to **Analyzer** page in RealAlgo
