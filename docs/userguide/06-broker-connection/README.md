...
RealAlgo supports 24+ Indian brokers through a unified interface. This guide covers connecting your broker account and understanding the authentication process.
...
## Configuring Broker in RealAlgo
...
1. In RealAlgo, click **Login to Broker**
2. You're redirected to broker's login page
3. Enter your broker credentials
4. Approve the connection
5. Automatically redirected back to RealAlgo

```
RealAlgo → Broker Login Page → Enter Credentials → Approve → Back to RealAlgo
```
...
3. RealAlgo uses stored credentials
...
In RealAlgo dashboard, you'll see:
...
1. Install RealAlgo in separate folders
