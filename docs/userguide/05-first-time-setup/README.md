...
You've installed RealAlgo. Now let's configure it properly for secure operation and connect it to your broker.

## Setup Wizard Overview

When you first access RealAlgo, you'll go through these steps:
...
Before using RealAlgo, you MUST set unique security keys.
...
4. Authorize RealAlgo
5. You'll be redirected back to RealAlgo
...
Congratulations! RealAlgo is now set up. Your next steps:
