...
RealAlgo is an open-source algorithmic trading platform that connects various trading platforms (TradingView, Amibroker, Python) to Indian stock brokers through a unified API.

### Is RealAlgo free?

Yes, RealAlgo is completely free and open-source. You can download, use, and modify it without any cost.

### Which brokers are supported?

RealAlgo supports 24+ Indian brokers including:
- Zerodha
- Angel One
- Dhan
- Upstox
...
### Can I use RealAlgo for live trading?

Yes, RealAlgo supports live trading with real money. However, we strongly recommend:
...
### Can I run RealAlgo on a VPS/Cloud?

Yes, RealAlgo can run on:
- AWS EC2/Lightsail
- Google Cloud
- DigitalOcean
- Azure
...
Most Indian brokers require daily authentication for security. This is a broker requirement, not an RealAlgo limitation.

### Can I use multiple brokers?

Currently, RealAlgo supports one broker at a time. You can switch between brokers by changing the configuration.
...
Yes, RealAlgo fully supports F&O trading. Use correct symbol format:
- Futures: `NIFTY30JAN25FUT`
- Options: `NIFTY30JAN2521500CE`

### What is Analyzer Mode?

Analyzer Mode is RealAlgo's sandbox testing environment. It simulates trading with ₹1 Crore sandbox capital using real market prices but no real money.

### Can I backtest strategies?

RealAlgo is primarily for live trading and walkforward testing strategies. For backtesting:
- Use TradingView's strategy tester
- Use Amibroker's backtesting
- Use Python backtesting libraries

### What happens if RealAlgo crashes during a trade?
...
### How do I connect TradingView to RealAlgo?

1. Enable RealAlgo accessible via internet (ngrok/cloud)
2. Create webhook alert in TradingView
3. Use RealAlgo endpoint URL
...
Report security vulnerabilities to: security@realalgo.in (or via GitHub private advisory)
...
### Is RealAlgo really free?

Yes, RealAlgo is 100% free and open-source under the AGPL license.

### Are there any hidden costs?

No hidden costs from RealAlgo. You may have:
...
### "RealAlgo is a trading bot"

RealAlgo is a **bridge/platform**, not a trading bot. It connects your strategy signals to your broker. You still need to create or use existing strategies.

### "I can make guaranteed profits"

No trading system guarantees profits. RealAlgo is a tool - your results depend on your strategy.

### "It works without internet"

RealAlgo requires internet connection to communicate with brokers and receive signals.

### "I can trade after market hours"

RealAlgo follows exchange timings. F&O can be traded during extended hours as per exchange rules.
...
2. Check [GitHub Discussions](https://github.com/marketcalls/realalgo/discussions)
