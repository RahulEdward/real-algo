...
**RealAlgo** is a free, open-source algorithmic trading platform that bridges your trading ideas with execution. Built with Python Flask and a modern React frontend, it provides a unified API layer across 24+ Indian brokers, enabling seamless automation from TradingView, Amibroker, Python scripts, Excel, and AI agents.

**Website**: [https://realalgo.in](https://realalgo.in)
**GitHub**: [https://github.com/marketcalls/realalgo](https://github.com/marketcalls/realalgo)
**Documentation**: [https://docs.realalgo.in](https://docs.realalgo.in)

## The Problem RealAlgo Solves
...
TradingView sends a signal
        ↓
RealAlgo receives it instantly
        ↓
...
| **Python Strategy Hosting** | Host and schedule Python strategies directly in RealAlgo |
...
**Benefit**: Switch brokers without changing your strategy code - RealAlgo's unified API handles the translation.
...
## What RealAlgo is NOT

Let's be clear about what RealAlgo doesn't do:
...
1. **Next**: Learn [Why Build with RealAlgo](../02-why-build-with-realalgo/README.md)
...
| Resource | Link |
|----------|------|
| **GitHub** | [github.com/marketcalls/realalgo](https://github.com/marketcalls/realalgo) |
...
**Next**: [02 - Why Build with RealAlgo](../02-why-build-with-realalgo/README.md) - Understand the value proposition.
