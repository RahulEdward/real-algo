...
All notable changes to RealAlgo will be documented in this file.
...
- Order field names aligned with RealAlgo schema
...
- What is RealAlgo, Key Concepts, System Requirements
...
- RealAlgo symbol format reference
...
- `db/realalgo.db` - Main database (users, orders, settings)
...
See [GitHub Releases](https://github.com/marketcalls/realalgo/releases) for previous version history.
...
- **Discord**: https://www.realalgo.in/discord
- **YouTube**: https://www.youtube.com/@realalgo
