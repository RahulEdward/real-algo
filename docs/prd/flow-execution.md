...
├── flow_realalgo_client.py     # RealAlgo API wrapper (~500 lines)
...
| `FlowRealAlgoClient` | Wraps RealAlgo internal APIs |
...
def execute_workflow(
    ...
    # 3. Create executor with RealAlgo client
    client = FlowRealAlgoClient(api_key)
