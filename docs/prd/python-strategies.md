...
Python Strategies enables traders to run custom Python trading algorithms within RealAlgo, with process isolation, market-aware scheduling, and comprehensive lifecycle management.
...
| ID | Requirement | Priority |
|----|-------------|----------|
| FR6.1 | RealAlgo SDK available to strategies | P0 |
| FR6.2 | Environment variables for API key | P0 |
| FR6.3 | Access to all RealAlgo API endpoints | P0 |
...
# Configuration
API_KEY = os.getenv('REALALGO_APIKEY')
HOST = os.getenv('REALALGO_HOST', 'http://127.0.0.1:5000')
SYMBOL = 'SBIN'
EXCHANGE = 'NSE'
QUANTITY = 1
