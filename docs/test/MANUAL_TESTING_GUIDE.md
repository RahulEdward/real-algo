# RealAlgo v2.0 - Comprehensive Manual Testing Guide
...
| Test | Steps | Expected | Status |
|------|-------|----------|--------|
| Build image | `docker build -t realalgo .` | Image built | [ ] |
| Run container | `docker run -p 5000:5000 realalgo` | App accessible | [ ] |
...
## Appendix: RealAlgo Symbol Format
