...
|-----------|-------------|-------------------|---------------|
| apikey | Your RealAlgo API key | Mandatory | - |
| symbol | Trading symbol in RealAlgo format | Mandatory | - |
...
| symbol | string | RealAlgo standard symbol |
| brsymbol | string | Broker-specific symbol |
| exchange | string | RealAlgo exchange code |
