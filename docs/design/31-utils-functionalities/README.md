...
The utils directory contains shared utility functions used across the RealAlgo platform for authentication, logging, configuration, and common operations.
