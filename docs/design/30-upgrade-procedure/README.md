...
Guidelines for upgrading RealAlgo to new versions while preserving data and configurations.
...
│  □ 5. Stop running RealAlgo instance                                       │
...
cp db/realalgo.db backups/$(date +%Y%m%d)/
...
# Restore databases
cp backups/YYYYMMDD/realalgo.db db/
...
echo "Starting RealAlgo upgrade..."
