...
RealAlgo includes an MCP (Model Context Protocol) server that enables AI assistants like Claude, Cursor, and Windsurf to control trading operations through natural language commands.
...
```python
@mcp.tool()
def get_realalgo_version():
    """Get RealAlgo version"""
...
// ~/Library/Application Support/Claude/claude_desktop_config.json
{
  "mcpServers": {
    "realalgo": {
      "command": "/path/to/realalgo/.venv/bin/python3",
      "args": [
        "/path/to/realalgo/mcp/mcpserver.py",
        "YOUR_API_KEY",
        "http://127.0.0.1:5000"
      ]
    }
...
realalgo==1.0.45      # RealAlgo Python client
...
| External: `realalgo` package | Python client library |
