...
Master contracts contain symbol mappings between RealAlgo's standardized format and broker-specific formats. They are downloaded daily and cached for fast symbol resolution.
...
│  │  3. Transform to RealAlgo format                                     │   │
...
│ symbol       │ VARCHAR      │ RealAlgo symbol format           │
