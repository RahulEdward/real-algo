...
RealAlgo uses **5 separate databases** for data isolation, performance optimization, and specialized use cases. This separation prevents contention and allows each database to be optimized for its specific workload.
...
│                                                                              │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐             │
│  │   realalgo.db   │  │    logs.db      │  │   latency.db    │             │
...
## Database 1: Main Database (realalgo.db)
...
│ overhead_ms      │ FLOAT        │ RealAlgo overhead│
...
| overhead_ms | Total RealAlgo overhead |
