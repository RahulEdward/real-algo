...
RealAlgo supports Time-based One-Time Password (TOTP) for two-factor authentication. Users can enable 2FA through QR code scanning with authenticator apps like Google Authenticator, Authy, or Microsoft Authenticator.
...
│  │  otpauth://totp/RealAlgo:user@example.com?secret=...&issuer=RealAlgo│   │
│  │           │                                                          │   │
│  │           ▼                                                          │   │
...
def get_provisioning_uri(secret, email, issuer="RealAlgo"):
...
```json
{
    ...
    "data": {
        ...
        "provisioning_uri": "otpauth://totp/RealAlgo:user@example.com?secret=JBSWY3DPEHPK3PXP&issuer=RealAlgo"
    }
}
```
