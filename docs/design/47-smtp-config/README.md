...
RealAlgo uses SMTP for sending email notifications, password reset links, and alerts. SMTP credentials are stored encrypted in the database for security.
...
You requested to reset your RealAlgo password.
...
<body>
    ...
    <p>You requested to reset your RealAlgo password.</p>
